...
(function (realRequire) {
  ...
  var pluginOpts = {
    ...
    renderWikiTextPragma: $tw.wiki
      .getTiddlerText('$:/config/markdown/renderWikiTextPragma')
      .trim(),
  };
  ...
  function setupWikiRules(pluginOptions) {
    ...
    wikiParser.pragmaRules = collectAllRules(
      wikiParser.pragmaRuleClasses,
      'pragma',
    );
    wikiParser.blockRules = collectAllRules(
      wikiParser.blockRuleClasses,
      'block',
    );
    wikiParser.inlineRules = collectAllRules(
      wikiParser.inlineRuleClasses,
      'inline',
    );
  ...
  function MarkdownParser(type, text, options) {
    ...
    try {
      wikiParser = new $tw.Wiki.parsers['text/vnd.tiddlywiki'](
        null,
        textToParse,
        {
          parseAsInline: true,
          ...
          rules: {
            pragma: {},
            block: this.blockRuleClasses,
            inline: this.inlineRuleClasses,
          },
        },
      );
    } catch (err) {
