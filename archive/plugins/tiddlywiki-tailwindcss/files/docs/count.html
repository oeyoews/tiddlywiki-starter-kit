    ...
    <div class="-m-4 flex flex-wrap text-center">
      <div class="w-full p-4 sm:w-1/2 md:w-1/4">
        <div class="rounded-lg border-2 border-gray-200 px-4 py-6">
          <svg
            ...
            stroke-width="2"
            class="mb-3 inline-block h-12 w-12 text-indigo-500"
            viewBox="0 0 24 24"
          >
      ...
      <div class="w-full p-4 sm:w-1/2 md:w-1/4">
        <div class="rounded-lg border-2 border-gray-200 px-4 py-6">
          ...
          <h2 class="title-font text-3xl font-medium text-gray-900">74</h2>
      ...
      <div class="w-full p-4 sm:w-1/2 md:w-1/4">
        <div class="rounded-lg border-2 border-gray-200 px-4 py-6">
          ...
          <h2 class="title-font text-3xl font-medium text-gray-900">46</h2>
