...
var s = {
  ...
  e = new /*#__PURE__*/ ((function () {
    ...
    return (
      ...
      (n.appendAnimationCss = function (t) {
        ...
        if (
          ...
          (e.type = 'text/css'), e.setAttribute(s, !0);
          var n = '';
          t.showCursor &&
            (n +=
    ...
    return (
      (s.typeHtmlChars = function (t, s, e) {
        ...
        if ('<' === n || '&' === n) {
          ...
          for (
            i = '<' === n ? '>' : ';';
            t.substr(s + 1).charAt(0) !== i && !(1 + ++s > t.length);
        ...
        if (!0 !== this.pause.status) {
          ...
          this.timeout = setTimeout(function () {
            ...
            if ((e.replaceText(i), e.smartBackspace)) {
              ...
              e.stopNum = r && i === r.substr(0, s) ? s : 0;
            }
            s > e.stopNum
              ? (s--, e.backspace(t, s))
              : s <= e.stopNum &&
