...
var tiddlywiki_config_mjs_1 = require("../tiddlywiki.config.mjs");
var fs_1 = require("fs");
dotenv_1.default.config();
var buildDir = ".tiddlywiki";
var log = (0, ora_1.default)("Building ...");
...
var buildStep = function (name, description) {
    log.start(description);
    (0, child_process_1.exec)("npx tiddlywiki . --build ".concat(name), function () {
...
var copyFiles = function () {
    log.info("📁 复制文件");
    (0, child_process_1.exec)("cp -r files vercel.json ".concat(buildDir));
};
function build() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            (0, tiddlywiki_config_mjs_1.default)();
            cleanBuildDir();
            buildAll();
            copyFiles();
            return [2 /*return*/];
