...
module.exports = function createImage(title, src) {
  ...
  const imageNode = createElement('img', {
    class: `object-cover w-full h-full spotlight rounded-md group-hover:scale-105 transition-all duration-800 ease-in-out shadow-md aspect-video animate-pulse`,
    attributes: {
      ['data-src']: src,
      title,
      loading: 'lazy',
